...
// Navodilo: uporabnik DOPOLNI tako, da odkomentira ustrezne definicije makrojev.
//
// Pojasnilo: s tem, ko odkomentiraš definicijo makroja, povzročiš, da obstaja makro
// s točno določenim imenom. In ta obstoj makroja povzroči, da se v programsko
// kodo vključi ustrezna koda.
